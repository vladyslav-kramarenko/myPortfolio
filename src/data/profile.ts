export const profile = {
  ...
  email: 'vladyslav.kramarenko.92@gmail.com',
  phone: '236 992 9229',
  ...
  certifications: [
    { name: 'AWS Certified Solutions Architect – Associate', id: 'SAA-C03' },
    { name: 'AWS Certified Developer – Associate', id: 'DVA-C02' },
    { name: 'AWS Certified Cloud Practitioner', id: 'CLF-C02' },
    { name: 'Meta Front-End Developer Certificate', id: 'Coursera' },
  ],
  skills: {
    'Languages & Scripting': 'JavaScript (Node.js · Google Apps Script), Python, SQL, Java',
    'Cloud Platforms': 'AWS (3× certified), GCP (BigQuery, Apps Script), DigitalOcean',
    'Identity & Endpoint': 'Microsoft Entra ID, Google Workspace, Apple Business Manager, Mosyle MDM',
